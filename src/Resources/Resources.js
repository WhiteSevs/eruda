...
export default class Resources extends Tool {
  ...
  refreshScript() {
    ...
    let scriptDataHtml = `<li>${i18n.t('Empty')}</li>`
  ...
  refreshStylesheet() {
    ...
    let stylesheetDataHtml = `<li>${i18n.t('Empty')}</li>`
  ...
  refreshIframe() {
    ...
    let iframeDataHtml = `<li>${i18n.t('Empty')}</li>`
  ...
  refreshImage() {
    ...
    let imageDataHtml = `<li>${i18n.t('Empty')}</li>`
